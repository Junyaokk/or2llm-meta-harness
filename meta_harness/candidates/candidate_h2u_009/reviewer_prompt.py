"""
Candidate H2U-009 — Trend Quality Vetting Reviewer.

Same active Reviewer from H2U-007 (calibration + evidence matrix).
The Trend Quality Vetting mechanism is in the Analyst and Decider.
The Reviewer provides a safety net for any remaining overrides that
the Decider's quality gating didn't catch.
"""
