"""
Candidate H2U-007 — Insight-Driven Override Modulation Reviewer.

Same active Reviewer from H2U-002 (calibration + evidence matrix).
The Insight Calibration mechanism is in the Decider, not the Reviewer.
"""
