"""
Candidate H2U-003 — Mean-Reversion Anchoring.
Decider scales override magnitude down as demand deviates further from
historical mean, counteracting the tendency to amplify overrides on extreme gaps.
Uses baseline Analyst thresholds.
"""
