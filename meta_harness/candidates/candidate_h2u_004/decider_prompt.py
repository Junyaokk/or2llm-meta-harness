"""
Candidate H2U-004 — Baseline Decider Prompt (unchanged from H2U-000).
The two-sided evidence mechanism is entirely in the Reviewer prompt.
"""
...
**Demand Trend (computed on recent trend_window={anticipated_lead_time}+0 periods):**
  ...
  - R-squared: goodness of linear fit on the trend window. High R^2 (>0.7) = sustained directional movement. Low R^2 = noisy.
...
4. RESOLVE CONFLICTS. The three sources are designed to sometimes disagree. Examples:
   ...
   - Memory insight says "sustained uptrend," Analyst confirms trend_dir=up with 5 evidence periods and high R^2. OR is definitely lagging — adjust upward meaningfully.
