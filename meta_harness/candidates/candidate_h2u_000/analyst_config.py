"""
Candidate H2U-000 — H2U Baseline: H2 Analyst + H2X Memory + Decider + Reviewer.

Analyst thresholds from H2 candidate_006 (optimized for L=0 and L=4).
Enables faster demand trend detection and lower OR bias threshold for
