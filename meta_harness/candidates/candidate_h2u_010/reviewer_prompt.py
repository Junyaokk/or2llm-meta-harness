"""
Candidate H2U-010 — Adaptive Coverage Bounds Reviewer.

Stockout Risk Floor Reviewer from H2U-008. Provides a complementary safety net:
the Decider's coverage bounds prevent catastrophic errors from within, while
the Reviewer's stockout assessment catches any remaining exposure from the
supply side. Together they form a defense-in-depth against zero-orders and
over-ordering on L>=2 instances.
"""
